  ...
  <section class="heading-page header-text" id="top">
    <div class="row">
      <div class="col">
        ...
        <table class="table1" id="user_details">
          <tr>
            <th>Id</th>
            <th>Name</th>
            <th>Number</th>
            ...
            <th>Slot</th>
            <th>time</th>
            <th style="text-align: center" colspan="2"><a href="user_add.php"><span class="fa-regular fa-plus"></span></a></th>
          </tr>
          <?php while ($row = mysqli_fetch_array($result, MYSQLI_BOTH)) {
            ...
            <tr>
              ...
              <td><a href="user_upd.php?id=<?php echo $row[0] ?>"><span class="fa-regular fa-edit" ></span></a></td>
                <td><a href="user_del.php?id=<?php echo $row[0] ?>" ><span class="fa-regular fa-trash"></span></a></td>
            </tr>
          <?php } ?>
        </table>
      </div>
